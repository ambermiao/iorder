      ...
      <div class="container">
        <div class="row">
          <div class="col col-lg-3">
            <div class="selector bg-white px-4 pb-4 shadow-sm rounded">
              ...
              <div class="block pt-3 border-top">
                ...
                <div class="custom-control custom-radio my-1">
                  <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input" value="9" v-model.number="rate">
                  <label class="custom-control-label" for="customRadio1">9+超棒</label>
                </div>
                <div class="custom-control custom-radio my-1">
                  <input type="radio" id="customRadio2" name="customRadio" class="custom-control-input" value="8" v-model.number="rate">
                  <label class="custom-control-label" for="customRadio2">8+很讚</label>
                </div>
                <div class="custom-control custom-radio my-1">
                  <input type="radio" id="customRadio3" name="customRadio" class="custom-control-input" value="7" v-model.number="rate">
                  <label class="custom-control-label" for="customRadio3">7+很好</label>
                </div>
                <div class="custom-control custom-radio my-1">
                  <input type="radio" id="customRadio4" name="customRadio" class="custom-control-input" value="6" v-model.number="rate">
                  <label class="custom-control-label" for="customRadio4">6+滿意</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col col-lg-9 restaurant-list">
            <div class="row">
              <div class="col col-lg-6 item mb-4" v-for="item in restaurantChange">
